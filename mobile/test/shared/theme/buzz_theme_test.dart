...
void main() {
  group('Buzz theme catalog entries', () {
    ...
    test('appear as a single System-mode option labelled "MAC Workspace"', () {
      ...
      expect(pairedThemeLabel(buzzThemeName), 'MAC Workspace');
      expect(
        themeSelectionLabel(buzzThemeName, ThemeMode.system),
        'MAC Workspace',
      );
      expect(
