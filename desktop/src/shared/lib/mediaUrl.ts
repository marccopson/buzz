 ...
 *
 * Only URLs hosted on the MAC Workspace relay are rewritten. External Blossom URLs
 ...
 * (the MAC Workspace relay), resulting in 404s.
 */
...
/**
 * If `url` is a Blossom media URL hosted on the MAC Workspace relay, rewrite it
