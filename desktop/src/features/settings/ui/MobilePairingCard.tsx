            ...
            <DialogDescription>
              {step === "sas"
                ...
                : step === "done"
                  ...
                  : "Scan this QR code with the MAC Workspace mobile app to securely pair."}
            </DialogDescription>
          </DialogHeader>
              ...
              <div className="space-y-4">
                <div className="flex flex-col items-center gap-3 py-4">
                  ...
                  <p className="text-center text-xs text-muted-foreground">
                    You are about to transfer your MAC Workspace identity to
  ...
  return (
    <section className="min-w-0" data-testid="settings-mobile">
      <SettingsSectionHeader
        ...
        description={
          <>
            Connect the MAC Workspace mobile app to this relay by scanning a QR
