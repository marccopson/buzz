...
const COPY_SUCCESS_MESSAGE =
  "Signed response copied. Paste it into the MAC Workspace admin console.";
const PREVIEW_COPY_SUCCESS_MESSAGE = "Preview response copied.";
const COPY_FAILURE_MESSAGE =
  "MAC Workspace couldn't access the clipboard. Try again.";
    ...
    const unlistenPromise = listenForNostrBindDeepLinks((nextPayload) => {
      ...
      getIdentity()
        ...
        .catch((error) => {
          ...
          setIdentity(null);
          setError("Could not load the current MAC Workspace identity.");
        });
    });
                ...
                >
                  <DialogPrimitive.Title className="mt-6 text-3xl font-semibold tracking-tight">
                    {payload.returnMode === "browser_fragment_v1"
                      ...
                      : "Finish on the MAC Workspace website"}
                  ...
                  >
                    {payload.returnMode === "browser_fragment_v1"
                      ? "MAC Workspace opened your browser to finish verification."
                      : "Copy the response below, then paste it into the MAC Workspace website to finish verification."}
                  </DialogPrimitive.Description>
