...
(`com.macsurfacing.workspace.dev` and per-worktree variants), a separate keyring service
...
`com.macsurfacing.workspace` data, `buzz-desktop` keyring service, or `~/.buzz` nest.
